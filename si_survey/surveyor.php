...
include("connection/connect.php");
   ...
   $prefik_id = "Surv-".date('d').date('M').date('Y')."-";

   $query=mysqli_query($connect,"SELECT COUNT(t_surveyor.`id_surveyor`)+1 as sufix_id
    FROM t_surveyor
    WHERE t_surveyor.`id_surveyor` LIKE '$prefik_id%'");
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Data Survey</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Kode Survey</label>

                  <div class="col-sm-10">
                      <label  for="inputEmail3" class="control-label"><input type="text" name="id_surveyor" value="<?php echo $id; ?>" readonly></label>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nama Surveyor</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" placeholder="Nama anda" name="nama"></input>
                    </div>
                </div>


                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Survey Arus</label>
                    <div class="col-sm-10">
                        <select class="form-control" name="survey_arus">
                          <option value="Mudik">Arus Mudik</option>
                          <option value="Balik">Arus Balik</option>
                       </select>
                    </div>
                </div>  
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Detail Lokasi</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="3" placeholder="Enter ..." name="detail_lokasi"></textarea>
                    </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" name= "tambah" class="btn btn-info pull-right" data-toggle="modal" data-target="#modal-success">Tambah Surveyor</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
...
<?php
    ...
    if(isset($_POST['tambah'])){
      ...
      $nama_surveyor      =$_POST['nama'];
      $kota_kab_surveyor  =$_POST['kota_kab'];
      $tanggal            =$_POST['tanggal'];
      $detail_lokasi      =$_POST['detail_lokasi'];
      $survey_arus        =$_POST['survey_arus'];
      $foto               =$_POST['foto'];
      $status_surveyor    = "Aktif";



        $tanggal            =$_POST['tanggal'];

      $cek_distinct_surveyor = mysqli_query($connect, 
        "SELECT * from t_surveyor WHERE id_surveyor ='$id_surveyor' ");
...
// }
      ...
      if(mysqli_num_rows($cek_distinct_surveyor) == 0){

          $tambahData = mysqli_query($connect, "INSERT into t_surveyor
            (
                id_surveyor,
                nama,
                kota_kab,
