          ...
          <div class="info-box bg-aqua">
            <span class="info-box-icon"><i class="fa fa-bookmark-o"></i></span>
              ...
              <?php
                  ...
                  $q_responden = mysqli_query($connect, "SELECT count(id_responden) AS  JML_RESPONDEN  from t_responden");
                  while($v_responden=mysqli_fetch_array($q_responden)){
                      ?>
                 
            <div class="info-box-content">
              <span class="info-box-text">Responden</span>
              <span class="info-box-number"><?php echo $v_responden['JML_RESPONDEN']; ?></span>
          ...
          <div class="info-box bg-green">
            <span class="info-box-icon"><i class="fa fa-thumbs-o-up"></i></span>
              <?php
                  ...
                  $q_surveyor= mysqli_query($connect, "SELECT count(id_surveyor) AS  JML_SURVEYOR  from t_surveyor");
                  while($v_surveyor=mysqli_fetch_array($q_surveyor)){
                      ?>
                 
            <div class="info-box-content">
              <span class="info-box-text">Surveyor</span>
              <span class="info-box-number"><?php echo $v_surveyor['JML_SURVEYOR']; ?></span>
          ...
          <div class="info-box bg-yellow">
            <span class="info-box-icon"><i class="fa fa-calendar"></i></span>
              ...
              <?php
                  ...
                  $q_kuesioner= mysqli_query($connect, "SELECT count(id_pertanyaan) AS  JML_PERTANYAAN  from t_pertanyaan");
                  while($v_pertanyaan=mysqli_fetch_array($q_kuesioner)){
                      ?>
            <div class="info-box-content">
              <span class="info-box-text">Kuesioner</span>
              <span class="info-box-number"><?php echo $v_pertanyaan['JML_PERTANYAAN']; ?></span>
